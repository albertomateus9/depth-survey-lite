# Survey Leve De Profundidade

Prototipo browser-side para mapa de profundidade e survey visual com fallback heuristico leve.

**Demo:** https://albertomateus9.github.io/depth-survey-lite/

## Visão Geral

Survey Leve De Profundidade é uma ferramenta de portfólio em Telecom + IA + Visão Computacional. O MVP foi mantido simples, executável e seguro para evoluções futuras sem depender de backend.
