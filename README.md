...
Browser-side depth-map survey prototype with heuristic fallback and optional Transformers.js hook.

## Overview

Depth Survey Lite is a browser-first MVP for the GitHub portfolio of Alberto Mateus P. da Gama. It is built to demonstrate low-cost computer vision applied to telecommunications, infrastructure operations, and technical education.
...
Depth Survey Lite e um MVP browser-first para o portfolio GitHub de Alberto Mateus P. da Gama. O projeto demonstra visao computacional de baixo custo aplicada a telecomunicacoes, operacoes de infraestrutura e educacao tecnica.
